...
export const projects: Project[] = [
  {
    ...
    technologies: ['TypeScript', 'JavaScript', 'React', 'Next.js', 'Node.js', 'Prisma', 'tRPC', 'Tailwind CSS', 'Zod', 'MySQL', 'Visual Studio Code'],
  ...
  },
  {
    ...
    technologies: ['JavaScript', 'React', 'Node.js', 'Express', 'Chart.js', 'MySQL', 'JWT', 'PDFKit', 'Visual Studio Code'],
    category: 'specialized',
